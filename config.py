...
# Эти ключи читаются в app.py (чтобы не падать при их отсутствии)
...
APP_CONFIG = {
    ...
    "theory_questions_count": 10,  # ⬅️ теория: РОВНО 10 вопросов
...
DEEPSEEK_CONFIG = {
    ...
    "max_tokens": 4000,
    "retry_attempts": 3,
    "timeout": 30,  # базовый; в app.py мы увеличиваем read-timeout
}
